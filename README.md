...
Rusty Gear Amulet : Made by placing 1 rope above 1 rusty gear in the crafting window. It must then be worn by pressing 'C' to bring up the Character UI and then placed into the top right necklace slot.

Temporal Gear Amulet : Made by placing 1 rope above 1 temporal gear in the crafting window. It must then be worn by pressing 'C' to bring up the Character UI and then placed into the top right necklace slot.
